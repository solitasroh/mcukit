 ...
 * L0-L1: strictest (docs/, .rkit/ only)
...
const LEVEL_SCOPE_OVERRIDES = {
  // L0-L1: strictest — only docs and .rkit state
  strict: {
    allowedPaths: ['docs/**', '.rkit/**'],
  ...
  moderate: {
    allowedPaths: ['src/**', 'lib/**', 'docs/**', 'test/**', '.rkit/**'],
...
function checkPathScope(filePath, automationLevel) {
  ...
  } catch (_e) { /* arch-lock module not available */ }
