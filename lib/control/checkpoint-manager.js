 ...
 *
 * Storage layout:
 *   .mcukit/checkpoints/index.json        — checkpoint index
 *   .mcukit/checkpoints/cp-{timestamp}.json — individual checkpoint snapshots
 *
...
const CHECKPOINTS_DIR = '.mcukit/checkpoints';
const INDEX_FILE = 'index.json';
const PDCA_STATUS_PATH = '.mcukit/state/pdca-status.json';
