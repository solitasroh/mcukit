...
/**
 * Standardized mcukit error with code, severity, and context.
 * @extends Error
 */
 ...
 * @param {string} [context.module='mcukit'] - Module name for debug logging
...
function safeCatch(fn, fallback, context) {
  ...
  try {
    ...
    try {
      ...
      debugLog(mod || 'mcukit', mcukitError.toDebugString(), mcukitError.context);
    } catch (_) {
