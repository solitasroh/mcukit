...
function migrateStatusV2toV3(v2) {
  ...
  v3.team = v3.team || {
    enabled: true,
    stateFile: '.mcukit/runtime/agent-state.json',
    eventsFile: '.mcukit/runtime/agent-events.jsonl',
  };
...
/**
 * Read memory state from .mcukit/state/memory.json
...
/**
 * Write memory state to .mcukit/state/memory.json
...
module.exports = {
  ...
  // v1.5.1: memory read/write (renamed from readBkitMemory/writeBkitMemory)
  readMemory,
  writeMemory,
