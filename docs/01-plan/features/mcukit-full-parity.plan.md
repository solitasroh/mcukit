# mcukit-full-parity Planning Document
...
| Perspective | Content |
|-------------|---------|
| **Problem** | mcukit에 PM Agent Team(6), PDCA Eval Agents(6), QA/Architecture Agents(8), Phase Skills(9), Eval 시나리오가 없어 bkit 대비 Agent 55%, Skill 75% 수준 |
...
| **Analysis** | bkit-impact-analyst, cc-version-researcher | 2 | mcukit 적응 (bkit→mcukit) |
...
| **bkit 전용** | bkit-rules, bkit-templates | 2 | **제외** (mcukit-rules로 대체됨) |
| **Workflow** | cc-version-analysis, zero-script-qa, pm-discovery, desktop-app, mobile-app | 5 | 이식 (cc-version→mcukit-version, desktop→wpf로 매핑) |
...
| **Workflow** | pdca, mcukit-rules, code-review, development-pipeline | 4 |
