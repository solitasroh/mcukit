# rkit-core Gap Analysis Report

> **Feature**: rkit-core (MVP-1 코어 이식 + 도메인 감지)
> **Date**: 2026-03-22
> **Design Reference**: `docs/02-design/features/rkit-core.design.md` v0.2
> **Phase**: Check (PDCA)
...
|------|------|------|:----:|
| plugin.json | O | O | ✅ |
| rkit.config.json | O | O | ✅ |
| skills/pdca/SKILL.md | O | O | ✅ |
| skills/rkit-rules/SKILL.md | O | O | ✅ |
...
1. `/pdca report rkit-core` → MVP-1 완료 보고서 생성
