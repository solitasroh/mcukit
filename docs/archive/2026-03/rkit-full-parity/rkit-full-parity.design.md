# rkit-full-parity Design Document

> **Summary**: bkit 완전 동등성 + MCU/MPU/WPF Eval 시나리오 상세 설계
>
> **Project**: rkit v0.5.0
> **Date**: 2026-03-22
> **Plan Reference**: `docs/01-plan/features/rkit-full-parity.plan.md`
...
### 이식 방법: bkit에서 복사 + `bkit:`→`rkit:` 이름 치환
...
| 21 | bkit-impact-analyst → rkit-impact-analyst | sonnet | 이름 변경 + 적응 |
...
| pm-discovery | 이식 |
| cc-version-analysis | 이식 → rkit-version-analysis 적응 |
...
| 7 | rkit-rules | workflow | bkit-rules 적응 |
| 8 | rkit-templates | workflow | bkit-templates 적응 |
