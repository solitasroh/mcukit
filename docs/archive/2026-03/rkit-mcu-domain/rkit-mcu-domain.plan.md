# rkit-mcu-domain Planning Document
...
> **Date**: 2026-03-22
> **Status**: Draft
> **Prerequisite**: rkit-core MVP-1 완료 (Match Rate 98.6%)
...
MVP-1에서 구축한 rkit PDCA 코어(141파일) 위에 **MCU 도메인 심화 기능**을 구현합니다. STM32와 NXP Kinetis K 플랫폼을 대상으로, 빌드 결과 자동 분석, 핀 할당 검증, 클럭 트리 검증, HAL/SDK 코딩 가이드를 제공합니다.
...
- MVP-1 완료 보고서: `docs/04-report/features/rkit-core.report.md`
- 원본 설계서 (MCU 모듈): `docs/02-design/features/rkit-core.design.md` Section 3.2
- 도메인 기술 검증: `docs/03-analysis/rkit-core-domain-verification.md`
...
> 이 섹션의 정보는 MVP-1 기술 검증에서 확인됨 (docs/03-analysis/rkit-core-domain-verification.md)
...
1. [ ] `/pdca design rkit-mcu-domain` - 상세 설계서
2. [ ] lib/mcu/ 4개 모듈 구현
