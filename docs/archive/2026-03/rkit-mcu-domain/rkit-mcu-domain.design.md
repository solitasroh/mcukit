# rkit-mcu-domain Design Document
...
> **Date**: 2026-03-22
> **Status**: Draft
> **Plan Reference**: `docs/01-plan/features/rkit-mcu-domain.plan.md`
 ...
 *
 * 탐색 순서:
 * 1. rkit.config.json → mcu.toolchain 값 (명시적 경로)
 ...
 *
 * 기준: rkit.config.json → mcu.memoryBudget
...
tools:
  ...
  - Glob
  - Grep
skills: [pdca, rkit-rules, stm32-hal, communication]
imports:
  - ${PLUGIN_ROOT}/refs/stm32/hal-patterns.md
...
## Warning Thresholds
- Flash: {flash_warning}% (rkit.config.json)
- RAM: {ram_warning}%
```
