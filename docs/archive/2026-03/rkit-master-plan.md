# rkit - MCU 개발 지원 Kit 마스터 기획서

## Executive Summary

| 항목 | 내용 |
|------|------|
| **프로젝트명** | rkit (MCU Development Kit for Claude Code) |
...
bkit의 "AI Native Web Development"
  → rkit의 "AI Native Embedded Development"
...
│   └── rkit-analysis-server/# 분석 도구 (MCU 특화 확장)
│
├── refs/                      # 레퍼런스 데이터
...
- [ ] `rkit.config.json` (bkit.config.json 기반 커스터마이즈)
