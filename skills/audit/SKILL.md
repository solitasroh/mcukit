...
description: |
  ...
  Browse and search through rkit's audit trail for transparency and debugging.
...
1. Read today's audit log from `.rkit/audit/YYYY-MM-DD.jsonl`
...
1. Read decision trace files from `.rkit/decisions/YYYY-MM-DD.jsonl`
...
2. Read relevant JSONL files from `.rkit/audit/`
